    ...
    if refined_disp != []:
      ...
      if len(unreasonable_fdp) != 0:
        if len(unreasonable_fdp) == 1:
          self.refinement_has_failed.append("<a href='spy.gui.SwitchTool(h2-info-anom-disp)>>spy.gui.tools.flash_gui_control(h2-Anom-Disp)' style='color: white'>%s has strongly deviating f''</a>" % unreasonable_fdp[0])
        else:
          self.refinement_has_failed.append("<a href='spy.gui.SwitchTool(h2-info-anom-disp)>>spy.gui.tools.flash_gui_control(h2-Anom-Disp)' style='color: white'>%s have strongly deviating f''</a>" % ",".join(unreasonable_fdp))
      if len(unreasonable_fp) != 0:
        if len(unreasonable_fp) == 1:
          self.refinement_has_failed.append("<a href='spy.gui.SwitchTool(h2-info-anom-disp)>>spy.gui.tools.flash_gui_control(h2-Anom-Disp)' style='color: white'>%s has strongly deviating f'</a>" % unreasonable_fp[0])
        else:
          self.refinement_has_failed.append("<a href='spy.gui.SwitchTool(h2-info-anom-disp)>>spy.gui.tools.flash_gui_control(h2-Anom-Disp)' style='color: white'>%s have strongly deviating f'</a>" % ",".join(unreasonable_fp))
