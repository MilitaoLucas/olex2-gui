...
# properties of "-next" must be ones generated by the Olex2 executable
# properties, "platform", "platform-portable", "platform-pyV" are generated by Olex2

mac64_legacy_port_name = 'port-mac64' # only for upgrade support
mac64_port_name = 'mac64-py38'
mac64_port_zip_name = 'olex2-mac64-intel.zip'
mac64_port_prefix = 'olex2.app/Contents/MacOS/'

mac64_next_port_name = 'mac64-py313'
...
win32_legacy_port_name = 'port-win32'
win32_port_name = 'win32-py38'
win32_port_zip_name = 'olex2-win32.zip'
win32_port_prefix = None

win64_legacy_port_name = 'port-win64'
win64_port_name = 'win64-py38'
win64_port_zip_name = 'olex2-win64.zip'
win64_port_prefix = None

win64_next_port_name = 'win64-py313'
...
external_files = {
  ...
  'plgl-win32-sse2.zip': ('olex-port', win32_port_name, 'action:extract', 'action:delete'),
  'python38-win32.zip': ('olex-port', win32_port_name,
    'action:rmdir Python38', 'action:rmdir Python',
    'action:extract', 'action:delete'),
  'hart-win32.zip': ('olex-port', win32_port_name, 'action:extract', 'action:delete'),
  #SSE2
  'cctbx-win32-sse2.zip': ('olex-port', win32_port_name,
    'action:rmdir cctbx', 'action:extract', 'action:delete'),
  # win64 shared
  'launch-win64.zip': ('olex-port',win64_legacy_port_name, win64_port_name, win64_next_port_name,
     'action:extract', 'action:delete'),
  'hart-win64.zip': ('olex-port', win64_port_name, win64_next_port_name,
    'action:extract', 'action:delete'),
  #windows 64
  'olex2-win64.zip': ('olex-port', win64_legacy_port_name, win64_port_name, 'action:extract', 'action:delete'),
  ...
  'python313-win64.zip': ('olex-port', win64_next_port_name,
    'action:rmdir Python',
    'action:extract', 'action:delete'),
  'cctbx-win64-next.zip': ('olex-port', win64_next_port_name,
    'action:rmdir cctbx', 'action:extract', 'action:delete'),
  #AC - semi-portable
  'ac-py38.zip': ('olex-port', win32_port_name, win64_port_name, lin64_port_name, mac64_port_name,
...
if platforms.get("win32"):
  t = threading.Thread(target=create_portable_distro,
    kwargs={
      "port_props": {win32_port_name},
      "zip_name": win32_port_zip_name,
      "port_zips": win32_zip_files,
      "prefix": win32_port_prefix,
      "extra_files":
      {
...
if platforms.get("win64-next"):
  t = threading.Thread(target=create_portable_distro,
    kwargs={
      "port_props": {win64_next_port_name},
